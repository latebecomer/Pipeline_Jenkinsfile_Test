...
LIBMWSF_RUNTIME_API void sf_attempt_to_read_queue_overflow_var_before_pop_error(SimStruct* S, unsigned int ssIdOfSourceObject, int offsetInSourceObject, int lengthInSourceObject);
